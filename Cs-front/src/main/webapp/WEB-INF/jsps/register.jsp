		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" action="<%= request.getContextPath()%>/UserController/register" method="post" novalidate="novalidate">
						<table>
							<tbody><tr>
								<th>
							...
							<tr>
								...
								<td>
									<input type="password" id="password" name="userPassword" class="text" maxlength="20" autocomplete="off">
								</td>
							</tr>
							<tr>
								<th>
							...
							<tr>
								...
								<td>
									<input type="text" id="email" name="userTel" class="text" maxlength="200">
								</td>
							</tr>
									<tr>
										<th>
									...
									<tr>
										...
										<td>
												<input type="text" name="userAddress" class="text" maxlength="200">
										</td>
									</tr>
...
<div class="ad">
	...
	<dd>
		自由退换、售后上门
								...
								<dd>
									立即登录即可体验在线购物！
									<a href="<%= request.getContextPath()%>/会员登录.htm">立即登录</a>
								</dd>
							</dl>
						</div>
					</form>
