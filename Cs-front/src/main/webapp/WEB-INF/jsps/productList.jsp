...
<div class="container productList">
		<div class="span6">
			<div class="hotProductCategory">
				<c:forEach var="class2" items="${list}">
						<dl>
							<dt>
								<%-- <a href="<%= request.getContextPath()%>/CommodityController/pageByClass2Id?page=1&size=1&class2Id=${class2.class2Id}"></a> --%>
							</dt>
									<dd>
										<a href="<%= request.getContextPath()%>/CommodityController/pageByClass2Id?page=0&size=1&class2Id=${class2.class2Id}">${class2.class2Name}</a>
									</dd>
